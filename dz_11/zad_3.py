...
class Rectangle:
    ...
    def __add__(self, other):
        """Определяет операцию сложения по ширине и высоте двух прямоугольников."""
        width = self.width + other.width
        height = self.height + other.height
        return Rectangle(width, height)

    def __sub__(self, other):
        """Определяет операцию вычитания по ширине и высоте одного прямоугольника из другого."""
        if Rectangle.perimeter(self) > Rectangle.perimeter(other):
            width = self.width - other.width
            height = self.height - other.height
        else:
            width = other.widhh - self.width
    ...
    def __repr__(self):
        """Возвращает строковое представление прямоугольника, которое может быть использовано
